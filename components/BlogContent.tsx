...
const components = {
  ...
  ul: (props: React.HTMLAttributes<HTMLUListElement>) => (
    <ul
      className="list-disc list-inside text-muted-foreground mb-6 space-y-2 ml-4"
      {...props}
    />
  ),
  ol: (props: React.HTMLAttributes<HTMLOListElement>) => (
    <ol
      className="list-decimal list-inside text-muted-foreground mb-6 space-y-2 ml-4"
      {...props}
    />
  ),
  ...
  pre: (props: React.HTMLAttributes<HTMLPreElement>) => (
    <pre
      className="p-4 rounded-lg bg-secondary overflow-x-auto mb-6 font-mono text-sm"
      {...props}
    />
  ),
  blockquote: (props: React.HTMLAttributes<HTMLQuoteElement>) => (
    <blockquote
      className="border-l-2 border-border pl-4 italic text-muted-foreground mb-6"
      {...props}
    />
  ),
  a: ({
