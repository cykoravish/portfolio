...
So yeah, let's talk about environment variables in a [MERN application](/projects) and how not to be like me.
...
Since most of my frontend work is built with [React and Next.js](/skills-tools), I had to understand how environment variables behave during the build process.
...
When I first started containerizing my app, I wrote about that chaos in my post on [Dockerizing my MERN app](/blog/dockerizing-mern-application).
...
- Production secrets managed through hosting platforms as part of my broader [DevOps deployment workflow](/services).
