...
I've had AI features in production for about six months now, after initially integrating GPT into my app as I described in my post on [adding AI to my MERN app](/blog/integrating-ai-into-mern-app).

This isn't about integration. It's about what happens after.

## Latency Is a Problem

AI APIs are slow compared to normal database queries in a typical [Node.js + MongoDB stack](/skills-tools). 2-3 seconds is common. Sometimes longer.

Users notice. Some assumed the app was broken, especially inside one of my larger [MERN projects](/projects).

Solutions that helped:
- Show a loading state immediately
- Use streaming for long responses
- Process in background and notify when done
- Cache aggressively — something I also learned while improving my [Node.js API performance](/blog/improving-nodejs-api-performance).
...
I log every AI interaction. Input, output, latency, cost, errors. And of course, API keys and model configs are handled through proper environment variables — something I learned the hard way in my guide on [handling environment variables in MERN](/blog/handling-env-vars-in-mern).
