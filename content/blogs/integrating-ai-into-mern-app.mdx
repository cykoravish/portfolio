...
Everyone's adding AI to everything now. I wanted to see what the hype was about. So I added GPT to one of my [MERN applications](/projects).
...
Since most of my backend runs on [Node.js with Express](/skills-tools), integrating the OpenAI SDK was simple.
...
API calls add up fast, especially once deployed in production as part of a broader [DevOps workflow](/services).

I made every mistake:
- Not caching responses for similar inputs — something I already learned while optimizing my [Node.js API performance](/blog/improving-nodejs-api-performance).
