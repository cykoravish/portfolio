...
So I figured, how hard could it be to containerize my [MERN application](/projects)? Write a Dockerfile, run a couple commands, done.
...
I also wrote about deploying without containers in my guide on [deploying MERN on a VPS](/blog/deploying-mern-on-vps).
