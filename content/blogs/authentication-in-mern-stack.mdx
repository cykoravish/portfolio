...
Authentication in [MERN stack application](/projects) seemed straightforward when I started. User enters credentials, you send back a token, they're logged in. Simple, right?
...
Since most of my stack is built with [Node.js and React](/skills-tools) I assumed JWTs would be straightforward to implement.
...
This became even more important once I started deploying to production environments and handling cross-origin requests properly as part of my [DevOps deployment process](/services).
...
I also make sure these auth changes go through automated tests before deployment, which I wrote about in my guide on [setting up CI/CD for MERN with GitHub Actions](/blog/ci-cd-mern-github-actions).
...
If you're building auth for the first time, you'll probably make such mistakes. That's fine. Just fix them before you go to production.